...
<div class="related">
	...
	<?php foreach ($menuCategory['ChildMenuCategory'] as $childMenuCategory): ?>
		<tr>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Dateforspecial'); ?></th>
		<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($menuCategory['MenuItem'] as $menuItem): ?>
		<tr>
			...
			<td><?php echo $menuItem['tagline']; ?></td>
			<td><?php echo $menuItem['price']; ?></td>
			<td><?php echo $menuItem['dateforspecial']; ?></td>
			<td class="actions">
